...
def format_api_response_with_timestamps(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    timestamp_fields = [
        'timestamp', 'created_at', 'updated_at', 'executed_at',
        'trade_time', 'order_time', 'market_time', 'last_updated'
    ]
...
def format_list_response_with_timestamps(data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """
...
def get_current_time_info() -> Dict[str, str]:
    ...
    """
    from src.shared.utils.timezone import now_utc, now_central, now_eastern
...
def get_market_status_info() -> Dict[str, Any]:
    ...
    """
    from src.shared.utils.timezone import (
        now_eastern, is_market_hours, is_weekend, 
        get_next_market_open, get_last_market_close
    )
