...
class TestServiceSchemas:
    ...
    def test_data_ingestion_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'data_ingestion'"))
            row = result.fetchone()
    ...
    def test_strategy_engine_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'strategy_engine'"))
            row = result.fetchone()
            assert row is not None
    ...
    def test_execution_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'execution'"))
            row = result.fetchone()
            assert row is not None
    ...
    def test_risk_management_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'risk_management'"))
            row = result.fetchone()
            assert row is not None
    ...
    def test_notification_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'notification'"))
            row = result.fetchone()
            assert row is not None
    ...
    def test_logging_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'logging'"))
            row = result.fetchone()
            assert row is not None
    ...
    def test_shared_schema(self, db_config):
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT schema_name FROM information_schema.schemata WHERE schema_name = 'shared'"))
            row = result.fetchone()
            assert row is not None
            assert row[0] == "shared"
